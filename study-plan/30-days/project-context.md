# Project context — Senior FE 30-day prep (Parker)
...
**Customer Verification Admin Console** — List, Detail, Field Config; roles Viewer | Editor | Admin.

- Scope & 15 deliverables: [capstone-brief.md](./capstone-brief.md)
- Feature write-up template: [feature-template.md](./feature-template.md)
- DoD / self-check: [definition-of-done.md](./definition-of-done.md), [self-check-questions.md](./self-check-questions.md)

## Stack / interview target

| Lens | Practice |
|---|---|
| Agnostic | Product, state ownership, API, a11y, perf, testing pyramid |
| Vue + TS | Repo notes under `src/vi/` + Week 4 Vue spike |
