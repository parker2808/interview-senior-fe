...
**Repo drill:** [`interview-senior-fe`](https://github.com/parker2808/interview-senior-fe) — ưu tiên files dưới `src/vi/`, JD map `jd1.md`  
...
|---|---|
| **Vue drill** | Đọc `src/vi/vue3.md` / `state-management.md` / `testing.md` rồi áp dụng concept |
...
| **TS** | `src/vi/typescript.md` dùng chung cho cả hai |
...
- `src/vi/practical-questions.md` — quy trình / bug vs feature
...
**Đọc**
- `src/vi/architecture.md` — Presentational vs Container
...
**Đọc**
- `src/vi/accessibility.md` — forms / labels
- `src/vi/vue3.md` — v-model, props *(Vue drill)*
...
**Đọc**
- `src/vi/css-layout.md` — Flex/Grid + responsive strategy
...
- `src/vi/leadership.md` — ước lượng độ phức tạp
...
**Đọc**
- `src/vi/practical-questions.md` — quản lý dự án
- `src/vi/leadership.md` — mentorship / communication
...
**Đọc**
- `src/vi/architecture.md` — patterns, SOLID
- `src/vi/vue3.md` — Composition API, provide/inject *(Vue drill)*
...
**Đọc**
- `src/vi/state-management.md` — flow, global vs local, Pinia/Vuex *(Vue drill)*
...
**Đọc**
- `src/vi/typescript.md` — interface/type, generics, narrowing, utilities
- `src/vi/javascript.md` — Promise/async, event loop
...
**Đọc**
- `src/vi/system-design.md` — component library
- `src/vi/monitoring.md` — error boundaries
...
**Đọc**
- `src/vi/css-layout.md` — responsive strategy
...
**Đọc**
- `src/vi/accessibility.md` — ARIA, keyboard, semantic, WCAG
- `src/vi/vue3.md` — Teleport *(Vue drill)*
...
**Đọc**
- `src/vi/networking.md` — REST vs WebSocket
- `src/vi/javascript.md` — async
- `src/vi/nuxt.md` — CSR/SSR/SSG *(high-level T-shaped; không bắt buộc Nuxt)*
...
**Đọc**
- `src/vi/practical-questions.md` — handling 401
- `src/vi/monitoring.md` — Sentry / logging
...
**Đọc**
- `src/vi/security.md` — XSS, CSRF, auth, validation, CORS
- `src/vi/performance.md` — localStorage vs session vs cookie
...
**Đọc**
- `src/vi/vue3.md` — debug component bugs *(Vue drill)*
- `src/vi/javascript.md` — event loop
- `src/vi/performance.md` — debounce/throttle
...
**Đọc**
- `src/vi/performance.md` — optimization, case studies, code splitting
- `src/vi/web-apis.md` — Intersection Observer, Workers
...
**Đọc**
- `src/vi/build-tools.md` — Vite vs Webpack
- `src/vi/monitoring.md` — performance monitoring
- `src/vi/system-design.md` — caching
...
**Đọc**
- `src/vi/devops.md` — GitOps high-level
- `src/vi/practical-questions.md` — Git flow
- `src/vi/leadership.md` — ADR template
- `src/vi/system-design.md` — architecture decisions
...
**Đọc**
- `src/vi/testing.md` — unit / component / E2E / coverage / TDD *(Vue + Vitest / Playwright trong repo)*
...
**Đọc**
- `src/vi/testing.md` — mocking async, Vue Test Utils
...
**Đọc**
- `src/vi/performance.md` — code review checklist
- `src/vi/leadership.md` — review tips
...
**Đọc**
- `src/vi/vue3.md`, `src/vi/state-management.md`, `src/vi/typescript.md`
...
- Skim yếu: chọn 1 trong `src/vi/system-design.md` / `src/vi/architecture.md` / `src/en/practical-questions.md` (EN wording)
...
| JD map | `jd1.md` |
| JS / TS | `src/vi/javascript.md`, `src/vi/typescript.md` |
| CSS / Responsive | `src/vi/css-layout.md` |
| Web APIs | `src/vi/web-apis.md` |
| Vue / Nuxt / State | `src/vi/vue3.md`, `src/vi/nuxt.md`, `src/vi/state-management.md` |
| Testing / Perf / Security / A11y | `src/vi/testing.md`, `src/vi/performance.md`, `src/vi/security.md`, `src/vi/accessibility.md` |
| Build / Net / DevOps | `src/vi/build-tools.md`, `src/vi/networking.md`, `src/vi/devops.md` |
| Arch / System / Leadership | `src/vi/architecture.md`, `src/vi/system-design.md`, `src/vi/leadership.md` |
| Practical / Monitoring | `src/vi/practical-questions.md`, `src/vi/monitoring.md` |
| EN twins | cùng tên dưới `src/en/` |
