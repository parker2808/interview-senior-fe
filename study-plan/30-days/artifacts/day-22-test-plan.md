...
3. **Copy** `capstone/12-test-plan.md`.
...
| Nguồn | Path | Ghi chú |
|---|---|---|
| Testing | `/workspace/src/vi/testing.md` | unit / component / E2E / coverage / TDD |
...
E2E hết? Test implementation detail?
...
→ [`capstone/12-test-plan.md`](./capstone/12-test-plan.md)
