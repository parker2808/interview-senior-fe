...
| Nguồn | Path | Ghi chú |
|---|---|---|
| DevOps | `/workspace/src/vi/devops.md` | GitOps high-level |
| Practical | `/workspace/src/vi/practical-questions.md` | Git flow |
| Leadership | `/workspace/src/vi/leadership.md` | ADR template |
| System design | `/workspace/src/vi/system-design.md` | Architecture decisions |
