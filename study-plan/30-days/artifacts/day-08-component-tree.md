...
| Nguồn | Path | Ghi chú |
|---|---|---|
| Architecture | `/workspace/src/vi/architecture.md` | Patterns, SOLID, Presentational vs Container |
| Vue drill | `/workspace/src/vi/vue3.md` | Composition API, provide/inject |
